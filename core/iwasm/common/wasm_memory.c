...
void* wasm_memory_get_heap_addr(void)
{
    return pool_allocator;
}
unsigned int wasm_memory_get_heap_size(void){
    return global_pool_size;
}

void wasm_memory_set_mode(Memory_Mode mode){
    memory_mode = mode;
}

void wasm_memory_set_heap_addr(void *addr){
    pool_allocator = addr;
}
void wasm_memory_set_heap_size(unsigned int size){
